...
worker.onmessage = async (e) => {
    ...
    if (msg.type === 'log') {
        ...
        logMessage('Compilation succeeded! Loading into Wagnostic Emulator...', false);
        ...
        try {
            if (window.wagnosticLoadRomFromBuffer) {
                ...
                logMessage('Wagnostic Emulator not initialized.', true);
            }
        } catch (err) {
            logMessage('Emulator error: ' + err, true);
        }
